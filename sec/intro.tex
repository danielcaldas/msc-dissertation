...
Next we present the steps trough data extraction to data visualization, that represent in a more general sense the structure and flow of data analyzes and visualization systems.

...
This measure reflects the number number of shortest paths going trough a particular actor. \textbf{Nodes that
...
\indent A common approach for detecting communities is trough graph clicks (subset of vertices of an
...
a node \textit{\textbf{v2}} if \textit{\textbf{v2}} needs to go trough \textit{\textbf{v1}} to reach a certain node \textit{\textbf{v3}}.

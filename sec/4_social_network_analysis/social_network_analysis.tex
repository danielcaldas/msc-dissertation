...
Graphs are typically the base of representation of social structures. This mathematical approach maps with  extreme convenience social networks. Nodes are individuals, and edges are relationships. Despite looking a quite simple approach, there is some basic math and algorithms that is of basilar importance for interpreting social networks.
...
\begin{itemize}
\item \textbf{\textit{Power Laws}};
\item \textbf{\textit{Random Graphs}};
\item \textbf{\textit{Centrality Measures}};
\item \textbf{\textit{Link Analysis}};
\item \textbf{\textit{Community Detection}};
\item \textbf{\textit{Spread of Information}};
\item \textbf{\textit{Social Learning}}.
\end{itemize}

%% ---------------------------------------------- Small World Problem, Stanley Milgram's Experiment
\section{Small World Problem, Stanley Milgram's Experiment}
This principle the \textit{small-world phenomenon}, is based on the idea that all human beings are connected by \textbf{short chains of acquaintances}. The pioneer of this work was Stanley Milgram.

\subsection{Six Degrees of Separation}
This idea is an extension of the small world problem. In the sequence of what we state before, the six degrees of separation materialize the previous concept in six interconnections to some individual reach some any other one. The concept a strong particular relevance when a play was written in the 90's portraying this concept.

\section{Network Visualization}
Network visualization may be consider as a science by itself, in this section we will explore some relevant techniques for network representation and visualization. We will look in particular to STAR
...
\begin{itemize}
    \item \textit{\textbf{Vizster}} \cite{2005-vizster} - Visualizing online social networks. A visualization system for playful end-user exploration and navigation of large-scale online social networks;

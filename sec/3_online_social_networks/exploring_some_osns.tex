...
\indent For building the network fetching users friends information is crucial, this was possible until Facebook Graph \gls{api} v2.0 (trough the router \textit{/me/friends}), one could actually retrieve

...
\begin{enumerate}
    \item max_clique
    \item enumerate_all_cliques
    \item number_of_cliques
    \item cliques_containing_node

    \item clustering
    \item average_clustering
    \item max_clustering

    \item average_neighbor_degree

    \item degree_centrality
    \item closeness_centrality
    \item betweenness_centrality
    \item eigenvector_centrality

    \item triangles

    \item is_strongly_connected
    \item number_strongly_connected_components
    \item strongly_connected_components

    \item is_weakly_connected
    \item number_weakly_connected_components
...
\begin{enumerate}
    \item The user must be able to register available \gslpl{osn} in the system;
    ...
    \item The user must be able to choose for each network node which details will be extracted within a given \gslpl{osn} \footnote{\textbf{Despite being these flags activated by the user, for privacy reasons some information will not be available, the web crawlers will never extract these kind of data}}:
    \begin{enumerate}
        \item \textbf{Facebook}:
        \begin{enumerate}
...
\begin{enumerate}
    ...
    be imported to other \gslpl{sna} tools such as Gephi or SocNetV;
    \item ...
\end{enumerate}
